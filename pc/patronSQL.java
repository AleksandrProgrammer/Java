...
public class patronSQL implements remark_Interface, General_Info_Interface, passwordInterface
{
	...
	public patronSQL(String aa, String bb, String cc, String dd, String gg, String ll, String hh, String ii, String jj, String kk)
	{
		...
		try {
 			...
 			System.err.println("unне удалось подключиться");
 		...
 		try
		 		...
		 		if (result == 1)
		 				...
		 				{
		 				JOptionPane.showMessageDialog(null, "Успешно создано");
		 				...
		 				JOptionPane.showMessageDialog(null, "не удалось создать");
							patron_text.setText("P-");
			            	name_text.setText("");
			 				passport_text.setText("");
			 				expiry_date_text.setText("");
	...
	public void delete()
	{
		try
 		{
 		Statement statement = con.createStatement();
 		int rs = JOptionPane.showConfirmDialog(null, "WARNING!! удалить да?", "CONFIRM", JOptionPane.YES_NO_OPTION);
